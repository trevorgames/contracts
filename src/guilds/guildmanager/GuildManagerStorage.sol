...
library GuildManagerStorage {
    struct Layout {
        ...
        /**
         * @dev The address of the trevorTag NFT contract (for ensuring user has a trevorTag when joining guilds)
         */
        address trevorTagNFTAddress;
    }
    ...
    /**
     * @dev Emitted when the requirement for a trevor tag is updated.
     * @param organizationId The ID of the guild's organization
     * @param requireTrevorTagForGuildsUpdated Whether this org requires trevor tags
     */
    event RequireTrevorTagForGuildsUpdated(bytes32 organizationId, bool requireTrevorTagForGuildsUpdated);
    ...
    /**
     * @dev Emitted when a user attempts to interact with a function gated to trevor tag holders.
     * @param user The address of the sender
     */
    error UserDoesNotOwnTrevorTag(address user);
    ...
    /**
     * @dev Emitted when the sender is neither the guild owner nor an admin and tries to perform an owner or admin
     * action.
     * @param sender The address of the sender attempting the action
     * @param action A description of the attempted action
     */
