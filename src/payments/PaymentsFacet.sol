 ...
 * @dev This facet exposes functionality to easily allow users to accept payments in ERC20 tokens or gas tokens (ETH,
 * MATIC, etc.)
...
contract PaymentsFacet is PaymentsV1, PaymentsV2 {
    ...
    function PaymentsFacet_init(
        ...
        public
        facetInitializer(keccak256("PaymentsFacet_init"))
    {
