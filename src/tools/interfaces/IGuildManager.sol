 ...
 * @param timeoutAfterLeavingGuild The timeout a user has before joining a new guild after being kicked or leaving
 * another guild
 ...
 * @param customGuildManagerAddress A contract address that handles custom guild creation requirements (i.e owning
 * specific NFTs).
...
struct GuildOrganizationInfo {
    ...
    bool requireTrevorTagForGuilds;
...
interface IGuildManager {
     ...
     * @param _customGuildManagerAddress A contract address that handles custom guild creation requirements (i.e owning
     * specific NFTs).
     * @param _requireTrevorTagForGuilds Whether this org requires a trevor tag for guilds
     ...
     * @param _timeoutAfterLeavingGuild The cooldown period a user has to wait before joining a new guild within the
     * organization.
     */
    ...
    /**
     * @dev Sets whether an org requires trevor tags for guilds
     * @param _organizationId The id of the organization to adjust
     * @param _requireTrevorTagForGuilds Whether trevor tags are required
     */
    function setRequireTrevorTagForGuilds(bytes32 _organizationId, bool _requireTrevorTagForGuilds) external;
     ...
     * @param _customGuildManagerAddress The contract address that handles custom guild creation requirements (i.e
    ...
    function guildSymbolInfo(
        ...
        external
        view
        returns (string memory symbolImageData_, bool isSymbolOnChain_);
