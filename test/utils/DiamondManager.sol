...
contract DiamondManager is TestBase, StdChains, StdUtils {
    ...
    /**
     * @dev Creates and sets up a new Diamond with the given facets. Includes AccessControl and OwnershipFacets
     * automatically
     */
